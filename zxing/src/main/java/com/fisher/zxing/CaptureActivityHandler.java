...
public final class CaptureActivityHandler extends Handler {
    ...
    IdecodeResultListener listener;
    ...
    public void setListener(IdecodeResultListener listener) {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.zxing_restart_preview) {
            ...
            Intent it = (Intent) message.obj;
            String result = it.getStringExtra(Intents.Scan.RESULT);
            listener.decodeQRSucc(result);
        }
