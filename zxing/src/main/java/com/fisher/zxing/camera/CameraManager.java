...
import com.fisher.zxing.camera.open.OpenCameraInterface;
...
//            int w_screen = display.getWidth();
//            int h_screen = display.getHeight();
//            framingRect = new Rect(w_screen / 2 - 300, h_screen / 2 - 300, w_screen / 2 + 300, h_screen / 2 + 300);

            FRAME_WIDTH =   display.getWidth() / 2;
            FRAME_HEIGHT = display.getWidth() / 2;
